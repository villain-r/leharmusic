...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/villain-r/vexaamusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ll_RAJJPUT_ll")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/LoSt_StOrY_V")
